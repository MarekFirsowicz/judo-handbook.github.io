...
const grading_data =[
    ...
    },
    {
        jap:'kesa-gatame',
        eng:'scarf hold',
        descr: "Kesa-gatame, often referred to as the \"scarf hold,\" is a widely practiced judo technique characterized by its distinctive control method. In this position, the practitioner sits beside the opponent's head, facing the opponent\u2019s feet, with the opponent\u2019s arm trapped against the practitioner\u2019s chest. The practitioner wraps one arm around the opponent\u2019s neck, holding onto the opponent\u2019s opposite armpit or the material of their judo gi for a secure grip.The practitioner\u2019s other arm can either support their position by pressing against the mat or further control the opponent by securing their arm or belt. The practitioner\u2019s legs are spread and positioned to maintain balance and apply pressure across the opponent\u2019s chest, inhibiting movement and making escape challenging. Kesa-gatame is a fundamental hold used in judo for controlling an opponent on the ground, exploiting the position to either transition to more dominant holds or to win by pinning.",
    ...
    },
    {
        ...
        descr: "Kuzure-Kesa-Gatame, also known as the \"modified scarf hold,\" is an advanced variation of the classic Kesa-Gatame used in judo. This technique modifies the basic scarf hold to increase control and reduce the opponent\'s chances of escape. In Kuzure-Kesa-Gatame, the practitioner positions themselves alongside the opponent, but instead of securing the neck, they opt to grip the opponent\'s near arm or belt, pulling it across and up towards their head.The practitioner\'s other hand often grabs the opponent\u2019s belt or pants at the back, pulling it tight to restrict movement. This adjustment shifts the hold's focus from the neck to controlling the opponent\u2019s upper body more comprehensively. The practitioner\u2019s legs are spread out to stabilize their base, ensuring that their weight is effectively distributed across the opponent\u2019s chest and shoulder, making the hold particularly difficult to escape. Kuzure-Kesa-Gatame is a favored technique in judo competitions for its effectiveness in maintaining ground control and securing victories through pins.",         
    ...
    {
        jap:'de-ashi-barai',
        descr: {'Starting Position': 'Maintain a light and mobile stance.', 
